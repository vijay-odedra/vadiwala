...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Owner email
    $owner_email = "danidhariyaharshil1111@gmail.com"; // 👈 replace with real owner email
    ...
    $ownerSent = mail($owner_email, $subject_owner, $message, $headers);
$customerSent = mail($email, $subject_customer, $message, $headers);
        ...
        <div class="modal-content">
            ...
            <form id="orderForm" action="https://api.web3forms.com/submit">
                ...
                <div class="form-group">
                    ...
                    <textarea id="specialInstructions" rows="3" name="specialInstructions"></textarea>
                </div>
